    ...
    implements PlayerModuleState
{
    ...
    public void applyToPlayer( final ServerPlayerEntity player )
    {
        ...
        ItemStackListHelper.assignItemStacks( this.enderChest, player.getEnderChestInventory().heldStacks );
    }
    ...
    public void loadFromPlayer( final ServerPlayerEntity player )
    {
        ...
        ItemStackListHelper.assignItemStacks( player.getEnderChestInventory().heldStacks, this.enderChest );
    }

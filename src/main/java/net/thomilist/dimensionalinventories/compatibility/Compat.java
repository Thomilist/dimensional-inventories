...
import net.thomilist.dimensionalinventories.compatibility.java.collection.*;
import net.thomilist.dimensionalinventories.compatibility.minecraft.inventory.SimpleInventoryCompatWrapper;
import net.thomilist.dimensionalinventories.compatibility.minecraft.inventory.SimpleInventoryCompatWrapper_Minecraft_1_20_1;
import net.thomilist.dimensionalinventories.compatibility.minecraft.nbt.NbtCompatWrapper;
import net.thomilist.dimensionalinventories.compatibility.minecraft.nbt.NbtCompatWrapper_Minecraft_1_20_1;
...
{
    // For Java versions
    public static final ListCompatWrapper LIST = new ListCompatWrapper_Java_17();
    public static final SortedSetCompatWrapper SORTED_SET = new SortedSetCompatWrapper_Java_17();

    // For Minecraft versions
    public static final NbtCompatWrapper NBT = new NbtCompatWrapper_Minecraft_1_20_1();
    public static final SimpleInventoryCompatWrapper SIMPLE_INVENTORY
        = new SimpleInventoryCompatWrapper_Minecraft_1_20_1();

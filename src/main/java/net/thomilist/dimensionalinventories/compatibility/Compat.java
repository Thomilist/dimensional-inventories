...
import net.thomilist.dimensionalinventories.compatibility.java.collection.ListCompatWrapper_Java_17;
import net.thomilist.dimensionalinventories.compatibility.java.collection.SortedSetCompatWrapper;
import net.thomilist.dimensionalinventories.compatibility.java.collection.SortedSetCompatWrapper_Java_17;
...
import net.thomilist.dimensionalinventories.compatibility.minecraft.nbt.NbtCompatWrapper_Minecraft_1_17;
...
public final class Compat
{
    ...
    public static final NbtCompatWrapper NBT = new NbtCompatWrapper_Minecraft_1_17();

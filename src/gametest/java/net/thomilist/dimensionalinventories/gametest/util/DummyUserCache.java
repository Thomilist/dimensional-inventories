    ...
    extends UserCache
{
    ...
    @Override
    public void add( final PlayerConfigEntry profile )
    { }

    @Override
    public Optional<PlayerConfigEntry> findByName( final String name )
    {
        return Optional.empty();
    }

    // @Override
    // public CompletableFuture<Optional<PlayerConfigEntry>> findByNameAsync( final String username )
    // {
    //     return CompletableFuture.supplyAsync( Optional::empty );
    // }

    @Override
    public Optional<PlayerConfigEntry> getByUuid( final UUID uuid )
    {
        return Optional.empty();
    }
